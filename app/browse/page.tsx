...
export default function BrowsePage() {
  ...
  const categories = {
    islam: {
      ...
      topics: Object.keys(responses).filter((key) => key.includes("islam") && !key.includes("christianity")),
    },
    christianity: {
      title: language === "en" ? "Christianity" : "Christianisme",
      topics: Object.keys(responses).filter((key) => key.includes("christianity") && !key.includes("islam")),
    },
    comparative: {
    ...
    nonfaith: {
      ...
      topics: Object.keys(responses).filter(
        (key) => key.includes("atheis") || key.includes("spiritual") || key === "atheism" || key === "spirituality",
      ),
    },
    clcp: {
